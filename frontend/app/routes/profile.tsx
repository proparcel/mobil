...
import type { UserProfile, CompanyProfile, CompanyMembershipRequest, UserExpertiseArea } from "../../src/types/auth";
...
export default function ProfileScreen() {
  ...
  const isCorporate = profile?.member_type === "corporate";
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.profileSectionBelowHeader}>
          <View style={styles.profileSectionRow}>
            ...
            <View style={styles.profileSectionCol2}>
              <Text style={styles.profileSectionUserName} numberOfLines={1}>
        ...
        {isIndividualOrConsultant ? (
          // Bireysel + Danışman İçeriği (Danışman: firma ilişkisi/pending istekler burada görünür)
          <>
            {/* Hesap Bilgileri */}
