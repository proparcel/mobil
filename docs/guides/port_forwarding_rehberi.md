...
## Sorun
Mobil cihazdan `http://78.186.188.162:8001` adresine erişilemiyor çünkü router'da port forwarding yapılmamış.
...
- Mobil veri kullanın
- Tarayıcıda şu adresi açın: `http://78.186.188.162:8001/api/`
