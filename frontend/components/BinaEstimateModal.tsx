...
type Props = {
  visible: boolean;
  onClose: () => void;
  onResult: (params: BinaParams | null) => void | Promise<void>;
  areaM2?: number;
};
...
const BinaEstimateModal: React.FC<Props> = ({ visible, onClose, onResult, areaM2 = 0 }) => {
...
export default BinaEstimateModal;
